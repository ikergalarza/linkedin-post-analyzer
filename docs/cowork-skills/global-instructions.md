...
4. **Menciones @:** por actividad real en LinkedIn (post/repost/comentarios en los últimos 3-6 meses). Descartar dormidos aunque sean el CEO de la región — un mando intermedio activo bate a un CEO silencioso.
