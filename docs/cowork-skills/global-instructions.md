...
3. **CTA:** ya NO usamos "comenta tu empresa" como cierre principal. Ahora el cierre lleva **link de agendar en spam ninja** (no el link del mapa de pampam — ese tráfico no convierte). Si mantienes una pregunta, convive con el link, no lo sustituye.
4. **Triage de menciones @** por actividad real en LinkedIn (último post/repost <3 meses + comentarios recientes). Descartar dormidos >3 meses aunque sean el CEO de la región — un mando intermedio activo bate a un CEO silencioso.
...
**Bloques de empresas:** SIEMPRE vacíos (el usuario los rellena a mano, NO inventar). 20 líneas en 5 bloques de 4:
```
→ XXX - XXX
→ XXX - XXX
→ XXX - XXX
