...
| **MEME** | agendar | 🚨 **SUSPENDIDA desde el 20/08** mientras dure la hipótesis de `post-workflow §4.5.0-PUERTAS` (los dos únicos posts con doble puerta, 19/08 y 20/08, son los dos únicos capados). Cuando vuelva: **OPCIONAL, y el presupuesto se mide SIN él** (ver `§4.4e-MEME`) | El chiste sigue teniendo sus 450 caracteres; lo que ocupa la puerta nueva no se le resta. Nunca se recorta el chiste para meter el segundo enlace. |
