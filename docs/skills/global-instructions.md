...
5. **Puntuación delatora (`brand-voice §3`):** busca `—` y busca `, y` / `, e` en TODO lo que entregas (post, spam ninja, CSV, descripciones). Cero guiones largos, cero comas antes de "y". Es un ctrl+F, no una impresión.
