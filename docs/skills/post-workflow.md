...
- **Framing de recurso, no de anuncio. Forma corta exacta: `Mapa completo aquí: {link}`** (sin coma, sin "empresa por empresa"). Es el molde literal que dio los CTR más altos (Galicia, Valencia, Bizkaia). NO "te decimos", NO "reserva", NO "agenda", NO alargarlo.
...
- **Martina Rosa Otero** (`martinarosaotero`): **34 posts ≥500c, top 6.128c**. Formato estrella: `🚨 D.E.P. [categoría], ADIÓS. 🚨` (alarma a los DOS lados) y `🚨 ÚLTIMA HORA: [Claude/GPT] ahora puede [X]`. Usa `↳` para presentar el recurso.
...
6. **IMAGEN = captura del propio recurso** (la lista de skills, la guía), reutilizable entre posts (`§4.5.-1`). No selfie.
