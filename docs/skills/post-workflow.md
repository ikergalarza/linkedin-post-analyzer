...
- **Activos COMENTANDO a otros** (han comentado en el post de alguien en los últimos 3 meses, vía `/users/{id}/comments`); si solo publican en su perfil pero no comentan a nadie, se descartan: no nos van a comentar (`§4.2 Paso 4`).
