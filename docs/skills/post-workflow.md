...
> - **⭐⭐ MÍNIMO 3 SELFIES CUADRADOS POR JEFE, y hoy solo los tiene UNO (Iker, 2026-08-18).** Con 3 se puede rotar sin repetir en un mes; con 1 el pilar se bloquea a la segunda semana. **Iker tiene 5; Unai y Asier tienen CERO.** Eso choca de frente con `§8.0-AGOSTO`, que mete historia en la rotación semanal de las tres cuentas: **sin banco, las historias de Unai y Asier no se pueden entregar completas.** Pedirles 3 selfies cuadrados a cada uno es un pendiente de bloqueo, no una mejora.
