...
- **⚠️ EXCEPCION AL EXACTO: las paginas con relleno de SEO en el nombre (Iker, 2026-07-29).** Hay empresas cuya pagina se llama `Fagor Automation | CNC & Feedback Systems | Automation Solutions` o `OJMAR - Intelligent Locking Systems`. Pegarlas enteras **come tres renglones** y, en el caso de OJMAR, deja **dos guiones en la misma linea**. Se inserta la mencion completa y **se borra la cola en el compositor de LinkedIn: el enlace sobrevive** al recorte. En el entregable se da el bloque ya recortado, mas una tabla aparte con el **nombre exacto de cada pagina** para que Iker acierte al elegir en el desplegable.
