...
- Mete aquí el **concepto despectivo original + "y poco más"** (`global §4.1`) y, si tienes el dato verificado, el **shock contra un país entero** como pago del underdog. **La región NO se nombra hasta el reveal**: los clichés van todos antes y solos ya la insinúan, igual que en el hook del mapa ("el patio trasero de los Pirineos" nunca dice Navarra).
