...
- **Exportar sin metadatos → SIEMPRE**, venga de donde venga. Eso va de la firma del generador, no del aspecto. **Se hace con `Archivo > Exportar > Exportar como` y `Metadatos: Ninguno`.** NUNCA con `Guardar como`, que los arrastra.
