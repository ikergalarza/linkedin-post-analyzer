...
|---|---|---|---|---|---|---|---|
| 2026-07-20 | Unai | Jue 23/07 | Meme | Motor · expectativa vs realidad (línea recta vs zigzag) | "el zigzag de ventas" | planificado | **remix del zigzag de Noam Nisand (119 likes · 6 rep · 126 comentarios)**, referencia sacada de **Unipile posts-search** (nuestra BD ya no tiene memes sin usar) · **NUEVA REGLA (Iker, 23/07): la referencia de meme necesita ≥100 likes** — el Aquaman de ayer tenía 80 y flopeó · motor psicológico (el electro emocional del que vende), inequívoco de ventas, limpio y NO infantil (cajón de Unai) · imagen: dos paneles, recta vs zigzag, etiquetas al español industrial, banner naranja donde iba el verde, sin pie, 1:1 · spam ninja fusionado (giro del zigzag → agendar, https) · ✅ validador 30/30 |
