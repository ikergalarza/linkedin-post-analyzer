...
- **Specs del GIF de Kaixito:** ≤500 KB (objetivo 200-400), ~600 px de ancho, colores planos (nuestro estilo flat comprime de lujo), 8-12 fps, **loop suave de 2-3 segundos**, y el **primer frame legible por sí solo** (Outlook clásico solo enseña el frame 1). Alt text siempre.
- **Posición: arriba, como hero** (Duolingo lo pone al ~23% del HTML, tras el logo). En nuestro caso: tras la primera línea de texto. **UNA animación por correo, nunca más.**
