...
11) "Ventas industriales + captura real de la herramienta" (Iker, 19 Jun) — 0.4x · 1.0K imp · PRODUCT-SCREENSHOT ≠ DESIRE-SCREENSHOT.
   Used a REAL screenshot of our product UI (a genuine documentary capture, well-intentioned as Motor B). Still flopped because it's a PRODUCT / SPAM post: zero curiosity gap, zero desire-figure, zero shock in the hook ("encontrar a quién venderle es la mitad del trabajo… casi nadie tiene la herramienta"). The screenshot proves something nobody asked about. CRITICAL DISTINCTION: Motor B (documentary screenshot) only works when the capture carries a DESIRE-FIGURE or personal tension (a 5.000€ invoice, a bank charge, a worried-partner iMessage). A product-UI screenshot with no figure/tension is just an ad → product-reach ceiling (~0.4x). Real capture ≠ automatically viral; it's the figure/tension + credibility that travels, not the screenshot itself.
