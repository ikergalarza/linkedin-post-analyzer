...
0. ⛔ CERO CIFRAS. Ninguna, en ninguna de las 4 partes. La regla 2 de más abajo también manda aquí y se la salta justo en este caso: en la primera prueba real escribió "YouTube tiene 2.700 millones de usuarios", que se la había inventado (2026-07-17). Es peor aquí que en una auditoría, porque la broma la lee TODO el hilo y un dato falso con el nombre del founder delante tira el post entero. No sabes cuántos usuarios tiene YouTube. Haz la broma sin números.
